...
import Contactndex from '../Contactndex';
...
const BottomTabContaactUs = ({route}) => {
  const [Change, setChange] = useState(route.params.name);

  return (
    <Tab.Navigator
      initialRouteName="Contactndex"
      screenOptions={{
        tabBarStyle: {
      ...
      <Tab.Screen
        name="Contactndex"
        component={Change == 1 ? Contactndex : HomeIndex}
        options={{
          headerShown: false,
...
export default BottomTabContaactUs;
