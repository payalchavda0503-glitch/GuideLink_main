...
import AvailibilityIndex from '../Index';
...
const BottomTabAvailibility = ({route}) => {
  const [Change, setChange] = useState(route.params.name);

  return (
    <Tab.Navigator
      initialRouteName="AvailibilityIndex"
      screenOptions={{
        tabBarStyle: {
      ...
      <Tab.Screen
        name="AvailibilityIndex"
        component={Change == 1 ? AvailibilityIndex : HomeIndex}
        options={{
          headerShown: false,
...
export default BottomTabAvailibility;
